...
## Project Structure
    ...
    ├── test_circa_web_figm_35392  # Django project configurations
...
1. Clone this repo and `cd test_circa_web_figm_35392`
...
2. Clone this repo and `cd test_circa_web_figm_35392`
